...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        test_author = Author.objects.create(first_name='John', last_name='Smith', date_of_birth='1976-01-12', date_of_death='2016-10-12')
    ...
    def test_form_date_of_death_initially_is_05_01_2018(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.get(reverse('author_create'))
        self.assertEqual(response.status_code, 200)
        
        initial_date = '05/01/2018'
